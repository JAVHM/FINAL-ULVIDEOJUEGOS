...
namespace MFlight.Demo
{
    ...
    public class Plane : MonoBehaviour
    {
        ...
        public float velocidadMovimientoMax = 600f;
        ...
        private void Update()
        {
            ...
            {
                pitchOverride = false;//CAMBIO MIO, ERA TRUE
                rollOverride = true;
            }
        ...
        private void FixedUpdate()
        {
            ...
            rigid.AddRelativeForce(Vector3.forward * currentSpeed * forceMult, ForceMode.Force);
